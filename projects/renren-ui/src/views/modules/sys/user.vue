  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-sys__user">
      ...
      <el-table v-loading="dataListLoading" :data="dataList" border @selection-change="dataListSelectionChangeHandle" @sort-change="dataListSortChangeHandle" style="width: 100%">
        ...
        <el-table-column prop="headUrl" :label="$t('user.headUrl')" header-align="center" align="center">
        ...
        <el-table-column prop="idNo" :label="$t('user.idNo')" header-align="center" align="center"></el-table-column>

        <el-table-column prop="authCode" :label="$t('user.authCode')" header-align="center" align="center"></el-table-column>
