  ...
  <el-dialog :visible.sync="visible" :title="!dataForm.id ? $t('add') : $t('update')" :close-on-click-modal="false" :close-on-press-escape="false">
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmitHandle()" label-width="120px">
      ...
      <el-form-item label="邀请码" prop="authCode">
        <el-input v-model="dataForm.authCode" :placeholder="$t('user.authCode')"></el-input>
      </el-form-item>
      <el-form-item label="头像" prop="headUrl">
        <el-upload class="avatar-uploader" :action="url" :show-file-list="false" :on-success="successHandle" :before-upload="beforeUploadHandle">
          <img v-if="dataForm.headUrl" :src="dataForm.headUrl" class="avatar" />
      ...
      // <el-form-item label="头像" prop="headUrl">
      //   //
      //   <el-upload :action="url" :file-list="fileList" drag :before-upload="beforeUploadHandle" :on-success="successHandle" class="text-center">
...
export default {
  data() {
    return {
      url: `${window.SITE_CONFIG["apiURL"]}/visit/visitordetail/upload?token=${Cookies.get("token")}`,
      visible: false,
      roleList: [],
      roleIdListDefault: [],
      dataForm: {
  ...
  computed: {
    dataRule() {
      ...
      return {
        ...
        authCode: [{ required: true, trigger: "blur", message: this.$t("validate.required") }],
        idNo: [{ required: true, trigger: "blur", message: this.$t("validate.required") }],
      };
    },
  },
  methods: {
...
.mod-sys__user .avatar-uploader .el-upload {
