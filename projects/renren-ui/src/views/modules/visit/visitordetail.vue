  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-demo__visitordetail}">
      ...
      <el-table v-loading="dataListLoading" :data="dataList" border @selection-change="dataListSelectionChangeHandle" style="width: 100%">
        ...
        <el-table-column prop="headUrl" label="头像" header-align="center" align="center"></el-table-column>
        ...
        <el-table-column prop="reqTime" label="预约日期" header-align="center" align="center"></el-table-column>
        ...
        <el-table-column prop="status" label="0 待审核 1 已审核 2 已驳回 3 已进场 4 已离场" header-align="center" align="center"></el-table-column>
        <el-table-column :label="$t('handle')" fixed="right" header-align="center" align="center" width="150">
          <template slot-scope="scope">
            <el-button v-if="$hasPermission('demo:visitordetail:update')" type="text" size="small" @click="addOrUpdateHandle(scope.row.id)">{{ $t("update") }}</el-button>
            <el-button v-if="$hasPermission('demo:visitordetail:delete')" type="text" size="small" @click="deleteHandle(scope.row.id)">{{ $t("delete") }}</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
  ...
  data() {
    return {
      mixinViewModuleOptions: {
        getDataListURL: "/demo/visitordetail/page",
        getDataListIsPage: true,
        exportURL: "/demo/visitordetail/export",
        deleteURL: "/demo/visitordetail",
        deleteIsBatch: true,
      },
      dataForm: {
        id: "",
